...
proc = subprocess.Popen(['bet temp.nii.gz out.nii.gz -f -v 0.3'], shell=True, cwd=os.path.split(result)[0], stdout = subprocess.PIPE, stderr=subprocess.STDOUT, stdin=subprocess.PIPE)
proc.stdin.close()
proc.wait()
result = proc.returncode
outputFile.write(proc.stdout.read())
# fsl.BET(in_file='/temp.nii.gz', out_file='/out.nii.gz', frac=0.5)