...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.log_2 = QtGui.QListWidget(self.layoutWidget)
        self.log_2.setMaximumSize(QtCore.QSize(16777215, 150))
        self.log_2.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOn)
        self.log_2.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOn)
        self.log_2.setSelectionMode(QtGui.QAbstractItemView.NoSelection)
        self.log_2.setVerticalScrollMode(QtGui.QAbstractItemView.ScrollPerPixel)
        self.log_2.setHorizontalScrollMode(QtGui.QAbstractItemView.ScrollPerPixel)
        self.log_2.setProperty("isWrapping", False)
        self.log_2.setViewMode(QtGui.QListView.ListMode)
        self.log_2.setObjectName(_fromUtf8("log_2"))
        self.verticalLayout_4.addWidget(self.log_2)
        ...
        self.gridLayout.addWidget(self.start, 1, 0, 1, 4)
