...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.scanList.setSelectionMode(QtGui.QAbstractItemView.NoSelection)
        self.scanList.setVerticalScrollMode(QtGui.QAbstractItemView.ScrollPerPixel)
        self.scanList.setHorizontalScrollMode(QtGui.QAbstractItemView.ScrollPerPixel)
        self.scanList.setProperty("isWrapping", False)
        self.scanList.setViewMode(QtGui.QListView.ListMode)
        self.scanList.setObjectName(_fromUtf8("scanList"))
        self.verticalLayout_4.addWidget(self.scanList)
